...
`sandbox/start.bat` does not force `main`. It starts whatever branch is currently checked out.
...
After that, `sandbox/start.bat` will pull the latest changes before launching.
